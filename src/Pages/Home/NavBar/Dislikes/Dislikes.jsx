...
const Dislikes = ({checkPage,isData,setIsData}) => {
    ...
    return(
        <div>
            <div className={s.dislikeContent}>
                <div className={s.dislikeHeader}>
                    <div className={s.btnBack}>
                        {btnBack}
                    </div>
                    <div className={s.dislikeTitle}>
                        <h2>Dislikes</h2>
                    </div>
                </div>
                <div className={s.dislikeGrid}>
                    <LoaderPhoto  page={page}  checkBtnNextforData={ checkBtnNextforData} setIsVoidData={setIsVoidData}
                                 isData={isData} setIsData={setIsData} checkPage={checkPage}/>
                </div>
