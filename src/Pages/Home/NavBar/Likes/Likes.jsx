...
const Likes = ({checkPage, isData ,setIsData}) => {
    ...
    return(
        <div>
            <div className={s.likeContent}>
                <div className={s.likeHeader}>
                    <div className={s.btnBack}>
                        {btnBack}
                    </div>
                    <div className={s.likeTitle}>
                        <h2>likes</h2>
                    </div>
                </div>
                <div className={s.likeGrid}>
                    <LoaderPhoto checkPage={checkPage} page={page}  checkBtnNextforData={ checkBtnNextforData}
                                 setIsVoidData={setIsVoidData} isData={isData} setIsData={setIsData}/>
                </div>
