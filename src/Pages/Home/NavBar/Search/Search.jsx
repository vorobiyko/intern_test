...
const Search = ({searchValue, checkPage}) => {
        ...
        <div>
            <div className={s.searchContent}>
                ...
                <div className={s.searchResults}>
                    <h3>Search results for: </h3><h2>{searchValue}</h2>
                </div>
                <div className={s.searchGrid}>
                    <LoaderPhoto name={searchValue} checkPage={checkPage} page={page}
                                 checkBtnNextforData={checkBtnNextforData} setIsVoidData={setIsVoidData}
                    isSearchData={isSearchData} setIsSearchData={setIsSearchData}/>
                </div>
